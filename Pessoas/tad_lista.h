...
@brief função que insere um valor (novo nó) na cabeça da lista
...
*/
int insercaoListaDupla (ListaDupla* l, int dado); 
...
/**
@removeFim (ListaDupla** l)
@brief função que remove valor do fim da lista
@param l é a lista de onde o valor será removido
@return 1 caso o valor tenha sido removido com sucesso, 0 caso contrario
*/
int removeFim (ListaDupla** l);
...
*/
int destroiListaDupla (ListaDupla** l); 
